...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
  ...
  [SEGAnalytics setupWithConfiguration:[SEGAnalyticsConfiguration configurationWithWriteKey:@"YCYSe3ErKA61FvHpfxLhEDlUWL1b8WGn"]];
  [Parse setApplicationId:@"tc7RioICzbmNTe875MtAppvFV48EJWjfmgEzJgxf"
   clientKey:@"dfLHTOtRTzSpSCAuz7WmIQvUSNzQyzc0bEb4fAMs"];
  [PFFacebookUtils initializeFacebookWithApplicationLaunchOptions:launchOptions];
  [PFLinkedInUtils initializeWithRedirectURL:@"http://neverdrinkaloneapp.com" clientId:@"77xanq8mbka4eg" clientSecret:@"VocKTOEj7Fuc8iz4" state:@"DCEEFWF45453sdffef424" grantedAccess:@[@"r_basicprofile", @"r_emailaddress"] presentingViewController:nil];
